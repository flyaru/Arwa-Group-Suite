...
export const mockDsrs: DSR[] = [
    ...
    { id: 'DSR-3', date: '2024-07-22', agentUsername: 'manager', agentName: 'Sales Manager', customerId: 'CUST-3', supplierId: 'SUP-3', serviceType: 'hotel', pnr: 'HLMNO4', ticketNo: 'N/A', route: 'Jeddah Hilton - 3 Nights', sellingFare: 1700, status: 'submitted', baseFare: 1600, taxes: 0, discount: 0, netFare: 1550, commission: 150, vatOnCommission: 22.5, paymentMethod: 'credit' },
